...
ft_search = json.loads('["An opportunity for a three-point play", "resorting to fouling", "Foul on purpose", "chance to score from the line", "free throws, a chance to increase their lead", "foul on the three", "fouled on the three", "potential four-point play", "tactical foul", "a four-point play chance", "strategic foul", "and draw the foul", "contact on the", "and one", "shooting foul", "foul on the shot", "and get fouled!", "foul strategy", "intentional foul", "fouling tactic", "strategically fouling", "fouling on purpose"]')
